...
<html lang="en">
	...
	<head>
		...
		<!-- Main CSS -->
	    <link rel="stylesheet" type="text/css" href="{{  asset('css/customer_dashboard_style.css')  }}">
            ...
            <div class="header">
                ...
                <div class="header-left" style="background-color: rgba(0,0,0,.7);">
					...
					<a href="#" class="logo logo-small">
						<img src="{{ asset('images/logo/logo.png') }}" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown">
						<a href="/profile" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="{{ asset('images/logo/logo.png') }}" width="31" alt="Ryan Taylor"></span>
						</a>
            ...
            <div class="page-wrapper">
				...
				<footer>
					<div class="row">
						...
						<div class="col-md-5"><p style=" text-align: center;">Copyright © 2017-2020 CardingEmpires.</p>	</div>
						<div class="col-md-4">	<img src="{{ asset('images/logo/norton.png') }}" alt=""></div>
					</div>
