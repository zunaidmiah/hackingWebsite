                    ...
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 mx-0">
                                <form action="/orderRequest/{{$item}}/{{$price}}" method="post" id="msform">
                                    @csrf
                                    <!-- progressbar -->
                                    <ul id="progressbar">
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <div class="radio-group">
                                                <ul>
                                                    <li>
                                                        <p><strong>Your Item : <input type="text" value="{{  $item  }} Cards" name="item" disabled></strong></p>
                                                    </li>
                                                    <li>
                                                        <p><strong>Your Total Amount : <input type="text" value="{{  $price  }}$" name="price" disabled></strong></p>
                                                    </li>
                                                    <li>
