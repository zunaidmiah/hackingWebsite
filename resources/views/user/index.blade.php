...
<html>
	<head>
		<title>CardingEmpire-Login Page</title>
		<meta charset="utf-8">
	...
	<body background="{{asset('images/wp2601081.jpg')}}">
		<center>
			<div id="outPopUp">
				<br><br>
				<form action="/authentication" method="post" name="sign in">
					{{ csrf_field() }}
					<div class="container">
						<div class="mb-3 heading">
					    <a href="/"><img src="{{ asset('images/logo/logo.png') }}" height="80" width="80" alt="Garuda Security Hacker" class="image"></a>
		...
		<style>
		html, body, center {
			cursor: url('../icon/cur1162.png'),auto;
		}
		#fot  {
			color: white;
